...
public class SliderManager : MonoBehaviour
{
    ...
    public bool vertical; //Platforms are by default horizontal. Setting this to true will rotate the object 90 degrees, and make it move up and down instead of side to side.
    ...
    void Start()
    {
        ...
        if(!vertical) //Rotate platform if needed.
        {
